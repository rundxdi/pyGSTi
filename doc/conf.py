# -*- coding: utf-8 -*-
#
# Gate Set Tomography documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('..'))  # so can import 'pygsti'
...
exclude_patterns = ['_build', '_templates', '_saved', '_apidoc']
...
htmlhelp_basename = 'GateSetTomographydoc'
...
latex_documents = [
    (master_doc, 'GateSetTomography.tex', u'Gate Set Tomography Documentation',
     u'Robin Blume-Kohout, John King Gamble, Erik Nielsen, Kenneth Rudinger', 'manual'),
]
